...
def create_design():
    ...
    s1_r = sc.Strand([ss1_r], idt=sc.VendorFields('s1_r'))
    s2_r = sc.Strand([ss2_r], idt=sc.VendorFields('s1_r'))
    s3_r = sc.Strand([ss3_r], idt=sc.VendorFields('s1_r'))
    s_l = sc.Strand([ss_l], idt=sc.VendorFields('s_l'))
