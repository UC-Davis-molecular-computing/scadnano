...
bool show_helices_axis_arrows_reducer(bool _, actions.ShowHelicesAxisArrows action) =>
...
AppUIStateStorables app_ui_state_storable_local_reducer(AppUIStateStorables storables, action) {
  ...
  b
    ...
    ..show_helices_axis_arrows = TypedReducer<bool, actions.ShowHelicesAxisArrows>(
