...
BuiltList<Strand> strands_delete_all_reducer(
  ...
  if (state.ui_state.select_mode_state.strands_selectable()) {
    ...
    strands = _remove_crossovers_and_loopouts(strands, crossovers, loopouts, state.dna_design);
    ...
    strands = _remove_bound_substrands(strands, substrands, state.dna_design);
  }
...
BuiltList<Strand> _remove_strands(BuiltList<Strand> strands, Iterable<Strand> strands_to_remove) =>
    strands.rebuild((s) => s..removeWhere((strand) => strands_to_remove.contains(strand)));

BuiltList<Strand> _remove_crossovers_and_loopouts(BuiltList<Strand> strands, Iterable<Crossover> crossovers,
    Iterable<Loopout> loopouts, DNADesign dna_design) {
...
BuiltList<Strand> _remove_bound_substrands(
    BuiltList<Strand> strands, Set<BoundSubstrand> substrands, DNADesign dna_design) {
  Set<Strand> strands_to_remove = {};
  List<Strand> strands_to_add = [];
