...
//DNADesign helix_rotation_set_reducer(DNADesign dna_design, actions.HelixRotationSet action) {
...
//}
//
//DNADesign helix_rotation_set_at_other_reducer(DNADesign dna_design, actions.HelixRotationSetAtOther action) {
...
//
////  print('&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&\n'
////      'Handled actions.HelixRotationSetAtOther and created new DNADesign:\n$dna_design_new');
//
