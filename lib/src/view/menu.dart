...
scadnano_file_loaded(FileReader file_reader, String filename) {
  ...
  app.dispatch(actions.LoadDNAFile(content: json_model_text, filename: filename, delay: true));
}
...
cadnano_file_loaded(FileReader file_reader, String filename) async {
  try {
    ...
    app.dispatch(actions.LoadDNAFile(
        content: json_cadnano_text, filename: filename, dna_file_type: DNAFileType.cadnano_file, delay: true));
