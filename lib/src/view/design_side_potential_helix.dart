...
class DesignSidePotentialHelixComponent extends UiComponent2<DesignSidePotentialHelixProps> {
  ...
  render() {
    ...
    if (grid.is_none) {
      ...
      svg_ideal_pos = side_view_grid_to_svg(
        props.grid_position!,
        props.grid,
        props.invert_y,
        props.geometry,
    ...
    String tooltip = '';
    if (props.grid.is_none) {
      Position3D pos = svg_side_view_to_position3d(props.mouse_svg_pos!, props.invert_y, props.geometry);
  ...
  _handle_click(SyntheticMouseEvent event) {
    ...
    if (props.grid.is_none) {
      Position3D position = svg_side_view_to_position3d(
        props.mouse_svg_pos!,
        props.invert_y,
        props.geometry,
      );
