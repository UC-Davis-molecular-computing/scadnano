...
//      print('mouseover data not null; creating DesignSideRotation now');
  ...
  _handle_click(SyntheticMouseEvent event, Helix helix) {
    if (event.altKey) {
      //FIXME: remove/add helix based on whether constants.KEY_CODE_SHOW_POTENTIAL_HELIX key is pressed
      // see design/design.dart for how to store whether that key is pressed to be checked here,
