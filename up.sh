...
scp build/examples/* doty@set.cs.ucdavis.edu:public_html/scadnano/examples/
scp build/examples/output_designs/* doty@set.cs.ucdavis.edu:public_html/scadnano/examples/output_designs/
