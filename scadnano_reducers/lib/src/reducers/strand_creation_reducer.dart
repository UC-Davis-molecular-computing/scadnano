...
GlobalReducer<StrandCreation?, AppState> strand_creation_global_reducer = combineGlobalReducers([
  ...
  TypedGlobalReducer<StrandCreation?, AppState, actions.StrandCreateAdjustOffset>(strand_create_adjust_offset_reducer),
  TypedGlobalReducer<StrandCreation?, AppState, actions.StrandCreateStop>(strand_create_stop_reducer),
]);

StrandCreation? strand_create_start_reducer(StrandCreation? _, AppState state, actions.StrandCreateStart action) =>
    StrandCreation(
...
StrandCreation? strand_create_adjust_offset_reducer(
  ...
  var new_address = Address(helix_idx: strand_creation.helix.idx, offset: new_offset, forward: strand_creation.forward);
...
StrandCreation? strand_create_stop_reducer(StrandCreation? _, AppState __, actions.StrandCreateStop action) => null;
