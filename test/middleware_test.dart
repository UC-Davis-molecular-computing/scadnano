      ...
      DNADesign expected_design = dna_design_from_string(r"""
        {
          ...
          "helices": [
            ...
            {
              "roll": 330,
              "position": {"x": 2.2524221697560485, "y": 1.0847093477938932, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 300,
              "position": {"x": 4.5796065413665605, "y": 0.17135678687790956, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 270,
              "position": {"x": 6.645203477156547, "y": -1.2369433582811473, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 240,
              "position": {"x": 7.017809142596987, "y": -3.7090204238439677, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 210,
              "position": {"x": 6.830983908630923, "y": -6.202029916796918, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 180,
              "position": {"x": 4.876405202460852, "y": -7.760754421443755, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 150,
              "position": {"x": 2.6239830327048033, "y": -8.845463769237648, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 120,
              "position": {"x": 0.2967986610942912, "y": -7.932111208321665, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 90,
              "position": {"x": -1.7687982746956945, "y": -6.523811063162608, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 60,
              "position": {"x": -2.1414039401361347, "y": -4.051733997599787, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            },
            {
              "roll": 30,
              "position": {"x": -1.9545787061700721, "y": -1.558724504646837, "z": 0},
              "major_ticks": [0, 10, 21, 31, 42, 52, 63],
              "max_offset": 64
            }
          ],
